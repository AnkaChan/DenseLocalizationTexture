...
def Resnet(n_layers, imgs_in, weight_decay, batch_norm_momentum, is_training, output_stride=16):
    ...
    with tf.contrib.slim.arg_scope(resnet_v2.resnet_arg_scope(weight_decay=weight_decay, batch_norm_decay=batch_norm_momentum)):
        features, _ = network(imgs_in, is_training=is_training, global_pool=False, output_stride=output_stride)
